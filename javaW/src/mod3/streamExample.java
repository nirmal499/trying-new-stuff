    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            fileContent.forEach((item) -> {
                System.out.print(" " + item);/* Notice we are using print not println */
            });
            ...
            fileContent.stream().sorted().forEach((item) -> {
                System.out.print(" " + item);/* Notice we are using print not println */
            });
            System.out.println(); // add an EOL
            ...
            /*
             * fileContent.stream().map(x -> Integer.parseInt(x) *
             * 2).forEach(System.out::print);
             */
            fileContent.stream().map(x -> Integer.parseInt(x) * 2).forEach((item) -> {
                System.out.print(" " + item);/* Notice we are using print not println */
            });
            System.out.println(); // add an EOL
            ...
            System.out.println(fileContent.stream().map(x -> Integer.parseInt(x)).reduce(Integer::sum));
        } catch (IOException ioe) {
