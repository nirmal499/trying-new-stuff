...
int main(int argc, char **argv)
{
    ...
    car_ctor(car);
    printf("Engine temperature before starting the car: %lf\n",
           car_get_engine_temperature(car));
    car_start(car);
    printf("Engine temperature after starting the car: %lf\n",
           car_get_engine_temperature(car));
    car_stop(car);
    printf("Engine temperature after stopping the car: %lf\n",
           car_get_engine_temperature(car));
