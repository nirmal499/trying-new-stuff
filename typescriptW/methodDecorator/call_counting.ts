...
const first = new Person1("Brendan", "Eich", new Date(1961, 6, 4));
const second = new Person1("Anders", "Hejlsberg ", new Date(1960, 11, 2));
const third = new Person1("Alan", "Turing", new Date(1912, 5, 23));
