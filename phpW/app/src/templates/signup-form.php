...
<div class="d-flex justify-content-center">
    <form action="/signup" method="post" style="width: 100%; max-width: 420px;">
        ...
        <div class="form-label-group mb-3">
            ...
            <input type="password" name="passwordVerify" id="inputPasswordVerify" placeholder="Password verify" class="form-control <?= isset($formError['passwordVerify']) ? 'is-invalid' : ''; ?>">
